...
> 本文是完整命令手册。上手请看仓库根目录的 [README](../README.md)；
> 给 agent 用的操作规范在 [`skill/SKILL.md`](../skill/SKILL.md)。
...
```
$ dsh-ui win list
[3] Safari浏览器 — "示例页面标题" pos=(-1358,38) size=1350x978 center=(-683,527) pid=6503
